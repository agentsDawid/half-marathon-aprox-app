    ...
    messages=[
        {
            ...
            "content": (
                ...
                "Czas na 5km MUSI być w formacie MM:SS (np. '30:00' dla 30 minut, '24:30'). "
                "Jeśli user napisał czas słownie (np. '30 minut', '30min'), przekonwertuj na MM:SS. "
                "Jeśli nie da się jednoznacznie przekonwertować, zostaw jako null."
